...
Given you have 5 galleries ['gallery1','gallery2','gallery3','gallery23','gallery34']
  ...
  <r:json_tags>
    <r:json_tags:pair name="name">
      <r:json_tags:array>
        <r:gallery:each>
          <r:json_tags:array:item><r:gallery:name/></r:json_tags:array:item>
        </r:gallery:each>
      </r:json_tags:array>
    </r:json_tags:pair>
    <r:escape_json key="description">I'm a string that needs escaping.</r:escape_json>
    <r:json_tags:pair name="options">
      <r:json_tags:object>
